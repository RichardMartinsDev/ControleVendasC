...
namespace Vendas_Inventario
{
    public partial class frmCustomersRecord : Form
    {
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Sinto Muito não existem dados para exportar par o Excel..", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            int rowsTotal = 0;
            int colsTotal = 0;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //O RELATORIO QUE VOCE CRIOU
                cmd = new OleDbCommand();
                OleDbDataAdapter myDA = new OleDbDataAdapter();
                SIS_DBDataSet myDS = new SIS_DBDataSet();
                //O DATASET QUE VOCE CRIOU
                con = new OleDbConnection(cs);
                cmd.Connection = con;
