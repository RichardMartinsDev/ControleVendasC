...
namespace Vendas_Inventario
{
        ...
        private void Reset()
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Informe o nome da empresa", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtCompanyName.Focus();
                return;
            }
            ...
            try
            {
                ...
                if (rdr.Read())
                {
                    MessageBox.Show("Empresa já existe", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtCompanyName.Text = "";
                    txtCompanyName.Focus();
