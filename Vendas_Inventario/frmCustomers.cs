...
namespace Vendas_Inventario
{
    public partial class frmCustomers : Form
    {
        ...
        private void txtZipCode_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                MessageBox.Show("Somente 6 digitos são permitidos", "Entrada Incorreta", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtZipCode.Focus();
            }
        }
        ...
        private void textBox1_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                MessageBox.Show("Somente 10 digitos são permitidos", "Entrada Incorreta", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtMobileNo.Focus();
            }
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Informe o nome", "Entrada Incorreta", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtCustomerName.Focus();
                return;
            }
            ...
            if (txtAddress.Text == "")
            {
                MessageBox.Show("Informe o endereço", "Entrada Incorreta", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtAddress.Focus();
                return;
            }
            if (txtCity.Text == "")
            {
                MessageBox.Show("Informe a cidade", "Entrada Incorreta", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtCity.Focus();
                return;
            }
            if (cmbState.Text == "")
            {
                MessageBox.Show("Selecione o estado", "Entrada Incorreta", MessageBoxButtons.OK, MessageBoxIcon.Error);
                cmbState.Focus();
                return;
            }
            if (txtZipCode.Text == "")
            {
                MessageBox.Show("Informe o CEP", "Entrada Incorreta", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtZipCode.Focus();
                return;
            }
            ...
            if (txtMobileNo.Text == "")
            {
                MessageBox.Show("Informe o no. do Celeular", "Entrada Incorreta", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtMobileNo.Focus();
                return;
            }
            ...
            try
            {
                ...
                if (rdr.Read())
                {
                    MessageBox.Show("Cliente ID já existe", "Entrada Incorreta", MessageBoxButtons.OK, MessageBoxIcon.Error);
                ...
                else
                {
                    ...
                    cmd.ExecuteReader();
                    MessageBox.Show("Salvo com sucesso", "Detalhes do Cliente", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show("Deseja deletar este registro?", "Registro de Cliente", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == System.Windows.Forms.DialogResult.Yes)
                {
                    delete_records();
                }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.Connection = con;
                cmd.ExecuteReader();
                MessageBox.Show("Atualizado com sucesso", "Detalhes do Cliente", MessageBoxButtons.OK, MessageBoxIcon.Information);
                btnUpdate.Enabled = false;
                if (con.State == ConnectionState.Open)
                {
                    con.Close();
