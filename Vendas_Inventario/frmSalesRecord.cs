...
namespace Vendas_Inventario
{
    ...
    String cs = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=|DataDirectory|\\SIS_DB.accdb;";
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Sinto muito não há dados para exportar par ao Excel", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            int rowsTotal = 0;
            int colsTotal = 0;
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Selecione o nome do Cliente", "Entrada Incorreta", MessageBoxButtons.OK, MessageBoxIcon.Error);
